# step15_baseline_full normalization + correction + validation report
...
- strict_high_on_valid_numeric: 955/1122 = 0.851159
...
## Artifacts
- `00_整理记录/step15_baseline_full_parameter_mentions.jsonl`
- `00_整理记录/step15_baseline_full_parameter_definitions.jsonl`
- `00_整理记录/step15_baseline_full_triples_spo.jsonl`
- `00_整理记录/step15_baseline_full_validation_report.json`
